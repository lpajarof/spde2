        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/estudiantes')) {
                ...
                if ($pathinfo === '/admin/estudiantes/list') {
                    return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::estudiantesListAction',  '_route' => 'estudiantesList',);
                }

                // estudiantesForm
                if ($pathinfo === '/admin/estudiantes/form') {
                    return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::estudiantesFormAction',  '_route' => 'estudiantesForm',);
                }

                // estudiantesAdd
                if ($pathinfo === '/admin/estudiantes/add') {
                    return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::estudiantesAddAction',  '_route' => 'estudiantesAdd',);
                }

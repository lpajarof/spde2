 ...
 */
class Programa extends \AppBundle\Entity\Programa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Programa' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\Programa' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Programa' . "\0" . 'idprograma'];
        }
    ...
    public function getIdprograma()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdprograma();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdprograma', []);

        return parent::getIdprograma();
    }

 ...
 */
class Clasificacion extends \AppBundle\Entity\Clasificacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Clasificacion' . "\0" . 'desertor', '' . "\0" . 'AppBundle\\Entity\\Clasificacion' . "\0" . 'anio', '' . "\0" . 'AppBundle\\Entity\\Clasificacion' . "\0" . 'periodo', '' . "\0" . 'AppBundle\\Entity\\Clasificacion' . "\0" . 'idclasificacion', '' . "\0" . 'AppBundle\\Entity\\Clasificacion' . "\0" . 'idestudiante'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Clasificacion $proxy) {
    ...
    public function setDesertor($desertor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDesertor', [$desertor]);

        return parent::setDesertor($desertor);
    }
    ...
    public function getDesertor()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDesertor', []);

        return parent::getDesertor();
    }
    ...
    public function getIdclasificacion()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdclasificacion();
        }

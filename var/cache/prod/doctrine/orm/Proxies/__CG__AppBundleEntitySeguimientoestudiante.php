...
class Seguimientoestudiante extends \AppBundle\Entity\Seguimientoestudiante implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Seguimientoestudiante' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\Seguimientoestudiante' . "\0" . 'fechainicio', '' . "\0" . 'AppBundle\\Entity\\Seguimientoestudiante' . "\0" . 'fechafin', '' . "\0" . 'AppBundle\\Entity\\Seguimientoestudiante' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\Seguimientoestudiante' . "\0" . 'idseguimientoestudiante', '' . "\0" . 'AppBundle\\Entity\\Seguimientoestudiante' . "\0" . 'idestudiante', '' . "\0" . 'AppBundle\\Entity\\Seguimientoestudiante' . "\0" . 'idaccion', '' . "\0" . 'AppBundle\\Entity\\Seguimientoestudiante' . "\0" . 'asignadoa'];
        }
    ...
    public function setIdaccion(\AppBundle\Entity\Accion $idaccion = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdaccion', [$idaccion]);
    ...
    public function getIdaccion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdaccion', []);

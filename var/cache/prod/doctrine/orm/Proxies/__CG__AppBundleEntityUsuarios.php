...
class Usuarios extends \AppBundle\Entity\Usuarios implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'identificacion', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'nombres', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'apellidos', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'contrasena', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'idtipousuario', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'idusuario', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'tipousuariostipousuarios'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTipousuariostipousuarios(\AppBundle\Entity\Tipousuarios $tipousuariostipousuarios = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipousuariostipousuarios', [$tipousuariostipousuarios]);

        return parent::setTipousuariostipousuarios($tipousuariostipousuarios);
    }

    /**
     * {@inheritDoc}
     */
    public function getTipousuariostipousuarios()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipousuariostipousuarios', []);

        return parent::getTipousuariostipousuarios();
    }
